...
/**
 This service class handles user authentication and registration using the UserRepository, TokenRepository,
 PasswordEncoder, JwtService and AuthenticationManager.
 It provides methods for registering a new user,
 authenticating an existing user and saving/retrieving authentication tokens from the database.
 */
@Service
